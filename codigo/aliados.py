...
class Turret(pg.sprite.Sprite):
    def __init__(self, hoja_sprites, fila, columna):
        ...
        self.lista_animacion = self.cargar_imagenes()
        self.indice_frame = 0
    ...
    def cargar_imagenes(self):
        ...
        size = self.hoja_sprites.get_height()
        lista_animacion = []
        for i in range(c.FRAMES_ANIM):
            temp_img = self.hoja_sprites.subsurface(i * size, 0, size, size)
